...
require 'src/GameObjectConsumable'
require 'src/GameObjectThrowable'
...
require 'src/states/game/ErrorState'
...
gTextures = {
    ...
    ['character_pot_lift'] = love.graphics.newImage('graphics/character_pot_lift.png'),
